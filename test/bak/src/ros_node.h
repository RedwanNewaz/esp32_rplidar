...
static const byte HEAD = 0xFF;        // Example value, adjust as needed
static const byte DEVICE_ID = 0xFC;   // Example value, adjust as needed
static const byte FUNC_MOTION = 0x12; // Example value, adjust as needed
static const byte CAR_TYPE = 0x01;    // Example value, adjust as needed
static const byte COMPLEMENT = 0x05;  // Example value, adjust as needed
